...
<body class="body-yeah">
    <div class="rule-container">
        ...
        <ul>
            ...
            <li>A user can check out a specific number of books at a time.</li>
            <li>Books can be issued for a predefined period.</li>
            <li>If the book is overdue, a late fee can be charged.</li>
            <li>A user should not be able to checkout the same book more than once if it is already checked out.</li>
        </ul>
